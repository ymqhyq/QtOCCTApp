...
#include "../../../../../../../../GitHub_Ymqhyq/SARibbon/src/SARibbonBar/SARibbonColorToolButton.h"
...
template <> constexpr inline auto SARibbonColorToolButton::qt_create_metaobjectdata<qt_meta_tag_ZN23SARibbonColorToolButtonE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SARibbonColorToolButton, qt_meta_tag_ZN23SARibbonColorToolButtonE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject SARibbonColorToolButton::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN23SARibbonColorToolButtonE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN23SARibbonColorToolButtonE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN23SARibbonColorToolButtonE_t>.metaTypes,
    nullptr
} };
...
void SARibbonColorToolButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SARibbonColorToolButton::*)(const QColor & , bool )>(_a, &SARibbonColorToolButton::colorClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SARibbonColorToolButton::*)(const QColor & )>(_a, &SARibbonColorToolButton::colorChanged, 2))
            return;
    }
}
...
void *SARibbonColorToolButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN23SARibbonColorToolButtonE_t>.strings))
