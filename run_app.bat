...
set IFC_BIN=D:\QtOCCTApp\3rpart\ifcopenshell-vs2019-x64\bin
...
echo Environment configured (VS2019 v142 Toolset, Qt 6.7.0).
echo Starting QtOCCTApp (Release Mode)...
