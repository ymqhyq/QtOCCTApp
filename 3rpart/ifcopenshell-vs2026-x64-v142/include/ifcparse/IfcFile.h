...
T* IfcParse::impl::in_memory_file_storage::create() {
    ...
    if constexpr (std::is_same_v<std::decay_t<std::invoke_result_t<decltype(&T::Class)>>, IfcParse::entity>) {
        inst = new T(in_memory_attribute_storage(T::Class().attribute_count()));
    } else if constexpr (std::is_same_v<std::decay_t<std::invoke_result_t<decltype(&T::Class)>>, IfcParse::type_declaration>) {
...
T* IfcParse::impl::rocks_db_file_storage::create() {
    if constexpr (std::is_same_v<std::decay_t<std::invoke_result_t<decltype(&T::Class)>>, IfcParse::entity> || std::is_same_v<std::decay_t<std::invoke_result_t<decltype(&T::Class)>>, IfcParse::type_declaration>) {
