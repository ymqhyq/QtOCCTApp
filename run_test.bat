...
set OCCT_3RD_FREEIMAGE=D:\QtOCCTApp\3rpart\opencascade-8.0.0-vc14-64-pch-with-debug-combined\3rdparty-vc14-64\freeimage-3.18.0-x64\bin
set OCCT_3RD_LZMA=D:\QtOCCTApp\3rpart\opencascade-8.0.0-vc14-64-pch-with-debug-combined\3rdparty-vc14-64\lzma-5.2.2-vc14-64\bin
set OCCT_3RD_ZLIB=D:\QtOCCTApp\3rpart\opencascade-8.0.0-vc14-64-pch-with-debug-combined\3rdparty-vc14-64\zlib-1.2.8-vc14-64\bin
set OCCT_3RD_TCLTK=D:\QtOCCTApp\3rpart\opencascade-8.0.0-vc14-64-pch-with-debug-combined\3rdparty-vc14-64\tcltk-8.6.15-x64\bin
